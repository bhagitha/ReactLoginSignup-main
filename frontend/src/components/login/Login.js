...
const history = useHistory()
    ...
    const login =()=>{
        axios.post("http://localhost:6960/Login",user)
    ...
    <div className="mt-8">
        <form action="#" autoComplete="off">
            <div className="flex flex-col mb-2">
                ...
                <div className="flex flex-col mb-6">
                    <div className="flex relative ">
                        ...
                        w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm 
            ...
            <div className="flex items-center justify-center mt-6">
                <Link to="/Register" className="inlin
                e-flex items-center text-xs font-thin text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white"  onClick={history.push("/Register")}>
                    <span className="ml-2">
